			...
			<form method="post" action="main">
				...
				<div class="d-flex flex-column align-items-center">
					<div
						...
						<p class="mb-1">제목</p>
						<input class="form-control input-custom mb-2" type="text"
							name="title" placeholder="제목">
					</div>
					<div
						class="d-flex flex-column justify-content-center align-items-start w-100">
						<p class="mb-1">내용</p>
						<textarea class="form-control input-custom content-input mb-2"
							name="content"></textarea>
					</div>
					<div class="d-flex justify-content-center align-items-center w-25">
						<button class="btn btn-primary btn-custom m-1">글쓰기</button>
						<button class="btn btn-danger btn-custom m-1"
							onclick="event.preventDefault(); history.back()">취소</button>
					</div>
				</div>
			</form>
		</section>
