...
<body>
    ...
    <div class="admin-sidebar">
        ...
        <ul class="admin-nav">
            ...
            <li class="admin-nav-item">
                <a href="/admin/articles" class="admin-nav-link active">
    ...
    <div class="admin-content">
        <div class="admin-header">
            <h4 class="admin-title">운동 영상 수정</h4>
        ...
        <div class="admin-card">
            ...
            <div class="admin-card-body">
                <form action="/admin/articles/edit" method="post" id="videoForm">
                    <div class="form-group">
                    	<input type="hidden" name="videoArticleId" value="${article.videoArticleId }">
                        <label for="title" class="form-label">영상 제목</label>
                        <input type="text" class="form-control" id="title" name="videoArticleTitle" placeholder="영상 제목을 입력하세요" value="${article.videoArticleTitle }" required>
                        <input type="text" class="form-control" id="title" name="videoArticleChannel" value="${article.videoArticleChannel }" placeholder="영상 채널명 입력하세요" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="url" name="videoArticleUrl" placeholder="예: https://www.youtube.com/embed/VIDEO_ID" value="${article.videoArticleUrl }"  required>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" id="part" name="videoArticlePart" value="${article.videoArticlePart }" required>
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        ...
                        <button type="submit" class="btn btn-admin-submit">수정하기</button>
                    </div>
                </form>
            </div>
        </div>
